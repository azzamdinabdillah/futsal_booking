...
const columns = [
    ...
    columnHelper.display({
        ...
        header: "Dimensi",
        cell: (info) =>
            `${info.row.original.length_m}m x ${info.row.original.width_m}m`,
    }),
    columnHelper.accessor("photos", {
        ...
        cell: (info) => {
            ...
            if (photos && photos.length > 0) {
                ...
                return h(
                    "div",
                    { class: "flex items-center space-x-1 min-w-[100px]" },
                    [
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                >
                    ...
                    <Link
                        ...
                        class="bg-primary text-white hover:opacity-90 px-4 py-2 rounded-md text-sm font-medium transition-colors"
                    >
                        + Tambah Lapangan
                    </Link>
                </div>
