...
<template>
    ...
    >
        <div
            class="p-4 text-2xl font-bold border-b border-white/10 flex justify-between items-center"
        >
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <Link
                href="/admin/bookings"
                class="block px-4 py-2 rounded hover:bg-white/10"
                :class="{ 'bg-white/20': isActive('/admin/bookings') }"
                @click="emit('close')"
            >
                Booking
            </Link>
            ...
            <Link
                ...
                method="post"
                as="button"
                class="block w-full text-left px-4 py-2 rounded hover:bg-white/10 text-red-300"
            >
                Logout / Home
            </Link>
        </nav>
